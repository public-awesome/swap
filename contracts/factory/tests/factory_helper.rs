...
use sg_swap::factory::{DefaultStakeConfig, PairConfig, PairType, PartialStakeConfig, QueryMsg};
...
impl FactoryHelper {
    pub fn init(router: &mut App, owner: &Addr) -> Self {
        ...
        let msg = sg_swap::factory::InstantiateMsg {
    ...
    pub fn update_config(
        ...
        let msg = sg_swap::factory::ExecuteMsg::UpdateConfig {
            token_code_id,
            fee_address,
    ...
    pub fn create_pair(
        ...
        let msg = sg_swap::factory::ExecuteMsg::CreatePair {
            pair_type,
            asset_infos,
            init_params,
    ...
    pub fn update_pair_fees(
        ...
        let msg = sg_swap::factory::ExecuteMsg::UpdatePairFees {
            asset_infos,
            fee_config,
        };
