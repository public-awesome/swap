...
use sg_swap::pair::InstantiateMsg as PairInstantiateMsg;
    ...
    assert_eq!(
        ...
        vec![SubMsg {
            msg: WasmMsg::Instantiate {
                ...
                label: String::from("Stargaze swap pair"),
            }
            .into(),
            id: 1,
            gas_limit: None,
...
fn register() {
    ...
    // Register an Stargaze pair querier
    deps.querier.with_sg_swap_pairs(&deployed_pairs);
    ...
    // Register stargaze pair querier
    deps.querier.with_sg_swap_pairs(&deployed_pairs);
