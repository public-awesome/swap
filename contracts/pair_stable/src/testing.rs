...
fn store_liquidity_token(deps: DepsMut, contract_addr: String) {
    ...
    let _res = sg_swap::pair::instantiate_lp_token_reply(
        &deps,
        res,
        &config.factory_addr,
    ...
    assert_eq!(
        ...
        vec![SubMsg {
            msg: WasmMsg::Instantiate {
                ...
                label: String::from("Stargaze Swap LP token"),
            }
            .into(),
            id: 1,
            gas_limit: None,
...
mod disabled {
    ...
    use sg_swap::asset::{native_asset, native_asset_info, PairInfo};
    use sg_swap::pair::{PoolResponse, SimulationResponse, TWAP_PRECISION};
