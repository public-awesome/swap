...
use sg_swap::factory::{DefaultStakeConfig, PairConfig, PairType, PartialStakeConfig};
...
use sg_swap::querier::NATIVE_TOKEN_PRECISION;
use sg_swap_pair_stable::contract::{execute, instantiate, query, reply};
...
impl Helper {
    pub fn new(
        ...
        let init_msg = sg_swap::factory::InstantiateMsg {
            fee_address: None,
        ...
        let asset_infos = asset_infos_vec
            ...
            .collect_vec();
        let init_pair_msg = sg_swap::factory::ExecuteMsg::CreatePair {
            pair_type: PairType::Stable {},
        ...
        let resp: PairInfo = app
            .wrap()
            .query_wasm_smart(&factory, &sg_swap::factory::QueryMsg::Pair { asset_infos })?;
